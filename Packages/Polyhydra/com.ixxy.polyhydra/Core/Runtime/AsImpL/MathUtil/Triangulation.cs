...
namespace AsImpL.MathUtil
{
    public static class Triangulation
    {
        ...
        /// </remarks>
        public static List<Triangle> TriangulateByEarClipping(List<Vertex> origVertices, Vector3 planeNormal, bool preserveOriginalVertices = true)
        {
            ...
            while (true)
            {
                ...
                if (earVertices.Count == 0)
                {
                    Debug.LogWarningFormat("Cannot find a proper reprojection. Using fallback polygon triangulation.");
