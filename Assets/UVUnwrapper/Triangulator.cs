...
namespace Unwrapper
{
    public static class Triangulator
    {
        ...
        {
            var angle = Mathf.Atan2(Vector3.Cross(a, b).magnitude, Vector3.Dot(a, b)) * Mathf.Rad2Deg;
        ...
        public static void Triangulate(List<Vector3> vertices, List<List<int>> faces, List<int> ring)
        {
            if (ring.Count < 3)
                return;
