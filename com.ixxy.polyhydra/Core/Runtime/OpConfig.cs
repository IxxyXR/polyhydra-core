...
namespace Polyhydra.Core
{
    ...
    public static class OpConfigs
    {
        ...
        public static readonly Dictionary<PolyMesh.Operation, OpConfig> Configs =
            new Dictionary<PolyMesh.Operation, OpConfig>
            {
                {
                ...
                },
                {
                    ...
                    {
                        usesFilter = true,
                        amountDefault = 0.5f, amountMin = -4, amountMax = 4, amountSafeMin = 0.001f,
                        amountSafeMax = 0.999f,
                ...
                },
                {
                    ...
                    new OpConfig
                    {
                        ...
                        amountMin = -4, amountMax = 4, amountSafeMin = 0.001f, amountSafeMax = 0.999f,
                        usesAmount2 = true,
                        amount2Min = -3, amount2Max = 3, amount2SafeMin = -0.5f, amount2SafeMax = 2
                    }
                },
                {
                ...
                },
                {
                    ...
                    {
                        amountDefault = 2f,
                        amountMin = 0, amountMax = 30f, amountSafeMin = 0f, amountSafeMax = 10f,
                        usesAmount2 = true,
                        amount2Default = 0.5f,
